...
app.use('/api/*', cors());
app.get('/', (c) => c.html(renderTextToolPage({ title: 'Landing Page Scorecard', description: 'Score a landing page across messaging, SEO, trust, CTA, and offer signals.', endpoint: '/api/score', sample: '{ "total": 78, "categories": { "seo": 20 } }', siteKey: turnstileSiteKeyFromEnv(c.env), buttonLabel: 'Score', toolSlug: 'landing-page-scorecard' })));
